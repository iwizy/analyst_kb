...
1. Какие признаки подсказывают, что задача решается DP?
2. Когда top-down удобнее bottom-up?
3. Почему DP может быть псевдополиномиальным?
4. Как уменьшить память в двумерном DP?
