...
1. Чем Big-O отличается от Big-Theta в практическом анализе?
2. Почему алгоритм с лучшей асимптотикой может работать медленнее на малых `n`?
3. Когда важнее память, чем скорость?
4. Какие метрики кроме Big-O вы используете в проекте?
