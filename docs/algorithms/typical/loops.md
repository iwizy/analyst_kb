...
1. Как доказать корректность цикла через инвариант?
2. В чем преимущество sliding window перед вложенными циклами?
3. Когда two pointers не подходят?
4. Почему важно тестировать граничные случаи отдельно?
