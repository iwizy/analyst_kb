...
| [Алгоритм](../../glossary.md#term-004) | Идея | Сложность |
| --- | --- | --- |
...
- [PERT](../../glossary.md#abbr-062)/CPM: расчет critical path для оценки сроков проекта.
...
## [Диаграмма](../../glossary.md#term-022): выбор графового алгоритма
