...
1. Почему B-tree чаще выбирают для СУБД, а не AVL?
2. Когда HashMap хуже дерева, несмотря на O(1)?
3. Какие структуры лучше для top-k задач?
4. Как профиль операций влияет на выбор структуры?
