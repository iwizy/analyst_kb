...
1. Какие критерии выбора алгоритма главные в вашем контексте?
2. Где допускается approximation, а где нет?
3. Как вы проверяете деградацию при росте данных?
4. Где лучше использовать библиотеку, а не кастомную реализацию?
