...
1. Какие свойства задачи делают greedy корректным?
2. Почему coin change иногда не решается greedy оптимально?
3. Как доказать оптимальность activity selection?
4. Где в вашем проекте greedy может дать достаточно хороший результат быстро?
