...
1. Чем divide & conquer отличается от dynamic programming?
2. Почему quicksort в худшем случае O(n^2)?
3. Когда master theorem не подходит?
4. Какие D&C алгоритмы уместно распараллеливать?
