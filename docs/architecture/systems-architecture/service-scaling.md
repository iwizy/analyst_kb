...
Масштабирование — способность системы держать рост нагрузки с сохранением [SLA](../../glossary.md#abbr-079) и контролируемой стоимости.
...
| Horizontal | добавляем инстансы | stateless [API](../../glossary.md#abbr-005), web workloads |
