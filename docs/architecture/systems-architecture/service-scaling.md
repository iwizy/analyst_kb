...
1. Что ограничивает масштаб сегодня: CPU, I/O, lock, network?
2. Сервис stateless или stateful и как это влияет на выбор?
3. Какая shard-стратегия подходит вашему профилю запросов?
4. Какие autoscaling метрики реально предсказывают деградацию?

## Чек-лист самопроверки

- bottleneck подтвержден метриками;
- выбран тип масштабирования;
- LB и failover стратегия определены;
- shard/partition policy документирована;
- autoscaling протестирован на пиковых сценариях.
