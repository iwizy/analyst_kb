...
1. Какие шаги процесса должны быть sync по бизнес-правилам?
2. Где можно безопасно перейти на async?
3. Как обеспечивается идемпотентность в критичных операциях?
4. Какие метрики показывают деградацию модели взаимодействия?

## Чек-лист самопроверки

- выбран подход sync/async по требованиям;
- заданы SLA и delivery guarantees;
- настроены timeout/retry/circuit или DLQ/replay;
- есть tracing и метрики цепочки;
- контракты взаимодействия версионируются.
