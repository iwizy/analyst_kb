...
- вводить паттерны через [ADR](../../glossary.md#abbr-003) и coding standards;
...
- определение;
- [UML](../../glossary.md#abbr-092)-схема;
- мини-пример кода;
...
Применение: события статусов, [UI](../../glossary.md#abbr-091) обновления.
