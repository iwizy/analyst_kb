...
- управлять error budget и [SLO](../../glossary.md#abbr-081).
...
| [Паттерн](../../glossary.md#term-052) | Что решает | Риски неправильной настройки |
| --- | --- | --- |
...
| Graceful degradation | сохраняет core-функционал | неконсистентный [UX](../../glossary.md#abbr-093) |
...
## Пример [SLA](../../glossary.md#abbr-079) уровней
