...
- [Event Sourcing и [CQRS](../../glossary.md#abbr-020)](event-sourcing-cqrs.md)
- [Синхронное и асинхронное взаимодействие](sync-async.md)
- [Кэширование](caching.md)
- [[Оркестрация](../../glossary.md#term-051) и хореография](orchestration-choreography.md)
- [Масштабирование сервисов](service-scaling.md)
- [Отказоустойчивость](resilience.md)
- [[API](../../glossary.md#abbr-005) Gateway и Service Mesh](api-gateway-service-mesh.md)
