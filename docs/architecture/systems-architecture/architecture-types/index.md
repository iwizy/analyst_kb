...
- учитывать NFR и операционную зрелость;
...
| [Микрофронтенды](microfrontends.md) | независимые UI-команды | UX/performance trade-off | большие продуктовые платформы |
...
1. Какие NFR не покрывает текущий стиль?
2. Что ограничивает текущий рост: код, данные или организация?
3. Готова ли команда к operational complexity нового стиля?
4. Какой минимальный шаг эволюции можно сделать без big-bang?

## Чек-лист самопроверки

- выбран стиль с учетом контекста, а не тренда;
- оценены плюсы/минусы и стоимость владения;
- зафиксирован migration path;
- определены риски и меры снижения;
- решение отражено в ADR.
