...
Микрофронтенды делят UI на доменные части с независимым lifecycle и ownership команд.
...
- поддерживать единый UX baseline.
...
2. Зафиксируйте API коммуникации между модулями.
