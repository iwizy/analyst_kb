...
1. Какая модель композиции выбрана и почему?
2. Кто владеет cross-cutting UI-компонентами?
3. Как обеспечивается единый UX между модулями?
4. Как контролируется performance на уровне платформы?

## Чек-лист самопроверки

- модель композиции зафиксирована;
- есть design system и контракт модулей;
- определены границы ownership;
- внедрены web-vitals и error monitoring;
- есть политика версий фронтенд-модулей.
