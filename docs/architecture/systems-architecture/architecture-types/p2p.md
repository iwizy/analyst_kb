...
1. Какие сценарии действительно требуют P2P, а не client-server?
2. Как обрабатываются конфликтующие обновления данных?
3. Как защищаетесь от Sybil и replay атак?
4. Как измеряете здоровье сети и узлов?

## Чек-лист самопроверки

- выбрана модель peer discovery;
- определен протокол маршрутизации и репликации;
- security-модель покрывает ключевые угрозы;
- предусмотрен NAT traversal;
- есть observability и recovery-процедуры.
