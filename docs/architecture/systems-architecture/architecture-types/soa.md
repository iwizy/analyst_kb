...
1. Чем SOA отличается от микросервисов в вашем контексте?
2. Где находится точка операционного bottleneck в текущем SOA?
3. Как управляются версии и совместимость контрактов?
4. Какие процессы требуют децентрализации?

## Чек-лист самопроверки

- каталог сервисов и контрактов ведется актуально;
- политика версионирования формализована;
- SLA/метрики определены по сервисам;
- ESB не содержит лишней бизнес-логики;
- есть план эволюции интеграционного слоя.
