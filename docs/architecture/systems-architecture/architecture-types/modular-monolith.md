...
1. Где проходит граница каждого модуля и кто owner?
2. Какие модули имеют наибольшую связанность и почему?
3. Какие модули готовы к выделению в сервис?
4. Есть ли ограничения по данным между модулями?

## Чек-лист самопроверки

- модули имеют четкие API;
- межмодульные зависимости контролируются автоматически;
- ownership и ответственность за данные зафиксированы;
- есть метрики связанности;
- подготовлен план эволюции в сторону сервисов.
