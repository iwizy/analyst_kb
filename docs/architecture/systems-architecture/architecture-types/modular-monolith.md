...
- понимать идею модулей и public [API](../../../glossary.md#abbr-005) внутри монолита;
...
1. Для каждого модуля: owner, [API](../../../glossary.md#abbr-005), данные, [SLA](../../../glossary.md#abbr-079).
2. Запрет прямых вызовов во внутренности соседнего модуля.
3. Введите dependency rules в [CI](../../../glossary.md#abbr-016).
4. Подготовьте module extraction backlog.
## Стандарты и источники

- [DDD](../../../glossary.md#abbr-024) references on bounded contexts.
