...
1. Какие события являются доменными, а какие техническими?
2. Как обрабатываются дубликаты и повторная доставка?
3. Где cold start критичен для бизнес-SLA?
4. Какой broker и почему выбран (Kafka/Pulsar/SQS и т.д.)?

## Чек-лист самопроверки

- события имеют owner и контракт;
- определены гарантии доставки;
- реализованы idempotency и DLQ;
- observability покрывает event flow;
- рассчитана стоимость serverless модели.
