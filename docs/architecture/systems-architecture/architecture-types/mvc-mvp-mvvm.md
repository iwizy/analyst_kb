...
Это паттерны организации [UI](../../../glossary.md#abbr-091)-логики, которые определяют разделение ответственности между представлением, состоянием и пользовательскими действиями.
...
| [Паттерн](../../../glossary.md#term-052) | Идея | Плюсы | Минусы |
| --- | --- | --- | --- |
