...
1. Какие зависимости между слоями запрещены?
2. Где должна жить бизнес-валидация?
3. Почему layered может деградировать по производительности?
4. Как layered сочетается с hexagonal?

## Чек-лист самопроверки

- слои и их ответственность описаны;
- направление зависимостей соблюдается;
- доменный слой независим от инфраструктуры;
- есть автоматические архитектурные проверки;
- есть performance-тесты на cross-layer сценариях.
