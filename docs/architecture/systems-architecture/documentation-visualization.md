# Документирование и визуализация архитектуры

Архитектура должна быть не только правильно спроектирована, но и правильно зафиксирована: понятными диаграммами и решениями в [ADR](../../glossary.md#abbr-003).

## Уровни сложности

### Базовый уровень

- использовать [C4](../../glossary.md#abbr-011) для контекста и контейнеров;
- делать читаемые [UML](../../glossary.md#abbr-092) component/deployment диаграммы;
- фиксировать ключевые решения в ADR.

### Средний уровень

- связывать диаграммы с требованиями и [NFR](../../glossary.md#abbr-053);
...
## [UML](../../glossary.md#abbr-092) component/deployment
...
## [ADR](../../glossary.md#abbr-003) шаблон
...
1. Для каждой значимой архитектурной развилки — отдельный [ADR](../../glossary.md#abbr-003).
2. Диаграммы и ADR храните рядом с кодом (Git).
3. Проставляйте ссылки на требования и [NFR](../../glossary.md#abbr-053).
...
- [C4](../../glossary.md#abbr-011) model: <https://c4model.com/>
