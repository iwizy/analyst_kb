...
1. Какие архитектурные решения уже зафиксированы в ADR?
2. Какие диаграммы нужны разным аудиториям?
3. Где сейчас highest documentation gap?
4. Как обеспечивается актуальность архитектурного репозитория?

## Чек-лист самопроверки

- C4/UML/Archimate применяются по назначению;
- ADR содержит контекст, альтернативы и последствия;
- диаграммы версионируются вместе с кодом;
- есть кросс-ссылки на требования и NFR;
- назначен owner документации.
