...
- one product, one product backlog, one [PO](../../glossary.md#abbr-065);
...
- [NFR](../../glossary.md#abbr-053) должны иметь общие для всех команд критерии [DoD](../../glossary.md#abbr-026).

## Типичные ошибки

- фактическое разделение backlog по командам;
- разные DoD в одном продукте;
- отсутствие интеграции инкремента к концу спринта.
