...
- единый Product Backlog используется на практике;
- feature teams кросс-функциональны;
- инкремент интегрируется каждый спринт;
- общие ретро приводят к системным улучшениям.

## Контрольные вопросы

1. Почему в LeSS важен один Product Owner?
2. Чем feature team отличается от component team?
3. Какие риски возрастают при масштабировании Scrum?
