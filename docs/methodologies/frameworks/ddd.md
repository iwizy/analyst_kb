...
- внедрение DDD только на уровне терминов без изменения структуры команд.

## Чек-лист самопроверки

- есть актуальная context map;
- бизнес-термины синхронизированы между командами;
- агрегаты имеют явные инварианты;
- интеграционные контракты закреплены и версионируются.

## Контрольные вопросы

1. Что такое bounded context и зачем он нужен?
2. Чем entity отличается от value object?
3. Какие риски возникают на границах контекстов?
