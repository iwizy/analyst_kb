...
- feature list связан с бизнес-целями;
- роли Chief Programmer/Class Owner определены;
- дизайн и реализация фич идут синхронно;
- статус фич прозрачен для бизнеса.

## Контрольные вопросы

1. Какой артефакт в FDD отражает прогресс в терминах бизнеса?
2. Чем Feature Plan отличается от Sprint Backlog?
3. Какую роль играет Chief Programmer?
