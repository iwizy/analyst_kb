...
1. Какой viewpoint выбран и для какой аудитории?
2. Видна ли связь бизнес-целей и технической реализации?
3. Определены ли владельцы архитектурных элементов?
4. Есть ли roadmap перехода от текущего к целевому состоянию?

## Чек-лист самопроверки

- scope и viewpoint определены;
- элементы и связи соответствуют Archimate semantics;
- есть связь с мотивацией и дорожной картой;
- модель поддерживает архитектурные решения;
- источники и версии стандарта зафиксированы.
