...
- связывать DFD с [API](../glossary.md#abbr-005)/event/file контрактами;
...
| помогает найти лишние и отсутствующие потоки | не заменяет [ERD](../glossary.md#abbr-032) для структуры данных |

## ERD vs [DFD](../glossary.md#abbr-025)
