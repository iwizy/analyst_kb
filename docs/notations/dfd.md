...
1. Все ключевые потоки данных отражены на диаграмме?
2. Есть ли баланс между контекстом и Level 0?
3. Каждому процессу назначен понятный вход и выход?
4. Можно ли по DFD выявить точки интеграционных рисков?

## Чек-лист самопроверки

- контекстная диаграмма построена;
- Level 0 и декомпозиция пронумерованы;
- потоки данных именованы;
- хранилища и внешние сущности определены;
- соблюдено правило баланса уровней.
