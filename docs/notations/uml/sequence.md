# [UML](../../glossary.md#abbr-092) Sequence Diagram

[Диаграмма](../../glossary.md#term-022) последовательности показывает порядок взаимодействия участников во времени и помогает анализировать интеграционные сценарии.
...
- связывать сообщения с [API](../../glossary.md#abbr-005)-контрактами.
...
| полезна для [API](../../glossary.md#abbr-005) и интеграционных ревью | требует дисциплины по уровню детализации |
