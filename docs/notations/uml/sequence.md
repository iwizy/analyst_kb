...
1. Указаны ли все внешние участники, влияющие на исход сценария?
2. Есть ли ветвь деградации и обработка ошибок?
3. Порядок вызовов соответствует реальной реализации?
4. Видно ли, где требуется идемпотентность или retry?

## Чек-лист самопроверки

- сценарий ограничен конкретной целью;
- указаны happy path и ключевые исключения;
- сообщения названы однозначно;
- есть связь с API/интеграционными контрактами;
- диаграмма проходит техническое ревью.
