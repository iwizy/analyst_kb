...
Диаграмма состояний описывает жизненный цикл сущности и события, которые переводят объект из одного состояния в другое.
...
| помогает QA строить тест-кейсы переходов | требует строгой дисциплины именования |
...
1. Для каждого состояния есть понятные входы и выходы?
2. Отражены ли условия отмены, таймаутов и возвратов?
3. Есть ли "тупиковые" состояния без выхода?
4. Можно ли из диаграммы построить набор тестов переходов?

## Чек-лист самопроверки

- список состояний полон и непротиворечив;
- события переходов названы однозначно;
- guard conditions учтены в критичных местах;
- есть терминальные исходы;
- модель согласована с бизнес-правилами.

## Стандарты и источники

- UML 2.5.1 State Machines: <https://www.omg.org/spec/UML/2.5.1>
