...
1. Каждая связь на диаграмме обоснована бизнес-правилом?
2. Кратности отражают реальные ограничения домена?
3. Нет ли смешения доменной и технической модели?
4. Поймет ли диаграмму новый участник команды?

## Чек-лист самопроверки

- выделены ключевые классы и их ответственность;
- связи и кратности проверены;
- композиция/агрегация применены осознанно;
- есть связь с требованиями и ERD;
- диаграмма читается без устного комментария.
