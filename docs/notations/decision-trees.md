...
- использовать дерево для бизнес-правил и SLA-маршрутизации;
...
1. Есть ли у каждого узла однозначные исходы?
2. Покрыты ли крайние и неопределенные случаи?
3. Можно ли выполнить решение без интерпретации "на глаз"?
4. Как измеряется эффективность дерева решений?

## Чек-лист самопроверки

- условия формализованы и измеримы;
- присутствуют fallback-ветки;
- дерево протестировано на реальных сценариях;
- назначен владелец правил;
- есть периодический пересмотр по данным.
