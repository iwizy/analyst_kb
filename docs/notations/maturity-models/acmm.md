...
- есть отдельные [C4](../../glossary.md#abbr-011)/Archimate схемы, но нет единого репозитория;
...
| Ошибка | Как избежать |
| --- | --- |
| оценка без бизнес-цели | связывайте maturity с [OKR](../../glossary.md#abbr-058) и рисками |
| нет архитектурного комитета | закрепляйте governance структуру |
| repo существует, но не актуален | назначайте владельцев и [SLA](../../glossary.md#abbr-079) обновления |
