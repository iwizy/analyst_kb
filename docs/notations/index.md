...
1. Какую управленческую или инженерную проблему решает выбранная модель?
2. Не смешаны ли уровни абстракции на одной схеме?
3. Поймет ли диаграмму человек без устного комментария автора?
4. Есть ли у модели владелец и дата следующего пересмотра?

## Чек-лист самопроверки

- цель и аудитория модели явно указаны;
- выбрана корректная нотация под задачу;
- диаграмма связана с требованиями и архитектурой;
- обозначения единообразны между разделами;
- добавлены источники и стандарты.
