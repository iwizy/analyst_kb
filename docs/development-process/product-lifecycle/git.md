...
- стратегия ветвления формализована и понятна команде;
- каждый релиз имеет tag и changelog;
- PR содержит ссылку на требование и результаты проверок;
- audit trail позволяет восстановить решение по любой задаче.

## Контрольные вопросы

1. Какая стратегия ветвления лучше подходит для вашего ритма релизов?
2. Как в вашем процессе прослеживается связь requirement -> commit -> release?
3. Какие проверки обязательны перед merge в основную ветку?
4. Как управляются hotfix и срочные изменения?
