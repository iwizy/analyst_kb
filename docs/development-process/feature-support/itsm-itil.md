# ITSM/[ITIL](../../glossary.md#abbr-044) процессы сопровождения

ITSM помогает управлять эксплуатацией как сервисом: с понятными ролями, [SLA](../../glossary.md#abbr-079) и контролем изменений. ITIL дает референс-практики, которые можно адаптировать под продуктовую команду.
...
- интегрировать ITSM с DevOps и [[CI](../../glossary.md#abbr-016)/CD](../../glossary.md#abbr-017).

### Продвинутый уровень

- строить service management для нескольких продуктовых команд;
- применять [KPI](../../glossary.md#abbr-047) ITSM ([MTTR](../../glossary.md#abbr-051), FCR, change success rate);
...
| --- | --- | --- |
| Incident Management | быстро восстановить сервис | восстановление SLA/[SLO](../../glossary.md#abbr-081) |
...
## Взаимодействие разработки, [QA](../../glossary.md#abbr-067) и эксплуатации
...
## [SLO](../../glossary.md#abbr-081)/[SLI](../../glossary.md#abbr-080)/[SLA](../../glossary.md#abbr-079) в сервисном контуре
