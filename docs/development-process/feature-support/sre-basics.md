...
- выбраны 2-5 значимых SLI на продукт;
- для каждого SLI есть измеримый SLO и период;
- есть политика действий при исчерпании error budget;
- reliability backlog приоритизируется наравне с feature backlog.

## Контрольные вопросы

1. Какие SLO отражают реальную пользовательскую ценность?
2. Что команда делает при исчерпании error budget?
3. Какие операционные задачи еще можно автоматизировать?
4. Как связаны SLO и решение о выпуске релиза?
