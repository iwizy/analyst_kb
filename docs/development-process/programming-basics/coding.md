...
- помогать команде проектировать [AC](../../glossary.md#abbr-002) в тестируемом формате;
...
- связывать изменения кода с архитектурными решениями и [ADR](../../glossary.md#abbr-003).
...
## Мини-пример: проверка [AC](../../glossary.md#abbr-002) в коде
