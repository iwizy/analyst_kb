...
- определены фазы SDLC и критерии перехода между ними;
- у команды есть единые DoR/DoD и quality gates;
- процесс покрывает полный контур: требования -> код -> тест -> эксплуатация;
- документация, риски и операционные процедуры ведутся системно;
- метрики процесса и качества используются для улучшений.

## Контрольные вопросы

1. Какие артефакты являются обязательными на каждом этапе SDLC в вашей команде?
2. Где в вашем процессе чаще всего теряется обратная связь от пользователей?
3. Какие quality gates реально блокируют некачественный релиз?
4. Какие метрики (lead time, CFR, MTTR) вы используете для процессных решений?
