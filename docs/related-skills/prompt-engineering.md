...
- промпт содержит контекст, ограничения и формат;
- результат прошел ручную валидацию;
- чувствительные данные не передавались в открытый контур;
- вывод зафиксирован как черновик, а не как финальный артефакт.

## Контрольные вопросы

1. Когда стоит снижать `temperature`?
2. Какие задачи аналитика лучше автоматизировать в первую очередь?
3. Как вы проверяете, что LLM не исказила исходные требования?
