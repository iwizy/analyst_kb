...
- использовать шаблоны для user stories, [AC](../glossary.md#abbr-002), test cases.
...
3. [Задача](../glossary.md#term-028): что требуется на выходе.
...
- AC измеримы;
- покрыты ограничения по безопасности и [SLA](../glossary.md#abbr-079).

### 2. Проверка согласованности требований

Запрос: найти противоречия между [BRD](../glossary.md#abbr-010) и [API](../glossary.md#abbr-005)-контрактом.
...
### 3. Генерация [SQL](../glossary.md#abbr-084)-черновика
