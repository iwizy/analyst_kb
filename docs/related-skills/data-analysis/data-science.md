...
- понимать [DS](../../glossary.md#abbr-028)-цикл: постановка задачи -> данные -> модель -> внедрение;
...
- задавать критерии [A/B](../../glossary.md#abbr-001)-проверки ML-фич.
...
3. Baseline и модель.
4. [Валидация](../../glossary.md#term-013) и ограничение рисков.
