...
Раздел помогает выбрать инструменты моделирования под разные типы артефактов: [UML](../glossary.md#abbr-092), [BPMN](../glossary.md#abbr-009), [C4](../glossary.md#abbr-011), ArchiMate, [ERD](../glossary.md#abbr-032) и процессные схемы.
...
- связь с требованиями/[AC](../glossary.md#abbr-002).

## Связь с требованиями и процессом

- требования: моделирование помогает уточнять границы системы и сценарии;
- архитектура: [C4](../glossary.md#abbr-011)/[UML](../glossary.md#abbr-092) фиксируют решения и зависимости;
- разработка: diagram review снижает риск неверной реализации;
- эксплуатация: диаграммы помогают в [RCA](../glossary.md#abbr-070) и изменениях.

## [Зависимость](../glossary.md#term-027) от методологии и архитектуры
...
- Process-heavy контур: приоритет [BPMN](../glossary.md#abbr-009)/DMN и сквозная трассировка решений.
...
- проверяйте совместимость плагинов [IDE](../glossary.md#abbr-040)/Confluence после обновлений.
