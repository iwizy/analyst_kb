...
- выбран инструмент под нужную нотацию и аудиторию;
- модель хранится в версионируемом формате;
- есть правила именования и review;
- диаграмма связана с требованиями и архитектурным контекстом.
