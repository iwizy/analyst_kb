...
1. Добавить AC в измеримом виде.
1. Связать FR с NFR, тестами и задачами.
...
- описание UI вместо бизнес-поведения;
...
| Postman / Swagger | Проверка API-поведения и контрактов для FR интеграций |
