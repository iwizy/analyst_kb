...
- простой спринтовый сценарий: User Story + [AC](../../glossary.md#abbr-002);
- сложный бизнес-процесс: Use Case;
- интеграционно сложный поток: сценарная карта + ограничения + [API](../../glossary.md#abbr-005)-связи.
...
1. Согласовать с [PO](../../glossary.md#abbr-065), Dev, [QA](../../glossary.md#abbr-067) (формат Three Amigos).
...
- есть [AC](../../glossary.md#abbr-002) для happy path и ключевых исключений;
...
- писать от задачи роли, а не от [UI](../../glossary.md#abbr-091)-компонента;
