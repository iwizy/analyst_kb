...
| UR | BR, исследования пользователей, процессы as-is/to-be | Сценарии, user stories/use cases, AC верхнего уровня |
...
1. Для каждого SR можно явно показать исходный BR/UR?
1. Не смешиваются ли в ваших BR технические детали реализации?
1. Есть ли критерии перехода между уровнями (quality gates) в процессе команды?
