# [Декомпозиция](../glossary.md#term-019) требований
...
Когда подходит: продуктовые команды и [UX](../glossary.md#abbr-093)-ориентированные инициативы.

### [Декомпозиция](../glossary.md#term-019) по событиям
...
- по интерфейсам/каналам (web/mobile/[API](../glossary.md#abbr-005)).
...
[Декомпозиция](../glossary.md#term-019):
...
- `[NFR](../glossary.md#abbr-053)-RET-004`: p95 расчета <= 1 сек при 100 [RPS](../glossary.md#abbr-075).
- `[AC](../glossary.md#abbr-002)-RET-031`: тестовые сценарии полного/частичного/ошибочного возврата.
...
- NFR: [SLA](../glossary.md#abbr-079) межсистемного обмена до 10 минут.
...
| How (SR) | FR/NFR/[API](../glossary.md#abbr-005)/данные/правила ошибок |
...
- декомпозиция без [NFR](../glossary.md#abbr-053);
- потеря связи с roadmap и релизными срезами.

## Практические рекомендации

- проводить декомпозию на сессии BA + [PO](../glossary.md#abbr-065) + Tech Lead + [QA](../glossary.md#abbr-067);
...
- есть связь с бизнес-целью и [KPI](../glossary.md#abbr-047);
- сформулированы [AC](../glossary.md#abbr-002) и тестовые сценарии;
