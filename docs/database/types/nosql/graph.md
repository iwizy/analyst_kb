...
1. Какие запросы на связи неэффективны в SQL, но естественны в графе?
2. Где риск supernode и как его снижать?
3. Какие данные остаются в primary OLTP?
4. Как проверяется целостность graph ETL/CDC?

## Чек-лист самопроверки

- графовая модель покрывает конкретный use case;
- настроены индексы и constraints;
- есть стратегия работы с supernodes;
- интеграция с OLTP и search документирована;
- соблюдены security и audit требования.
