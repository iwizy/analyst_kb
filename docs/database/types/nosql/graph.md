...
- ограничивайте глубину traversal в online [API](../../../glossary.md#abbr-005).

## Безопасность

- [RBAC](../../../glossary.md#abbr-069) по графовым сущностям;
- аудит чтения чувствительных связей;
- шифрование in-transit/at-rest.

## [Миграция](../../../glossary.md#term-045) из реляционной модели

1. Выделить сценарии, где join depth критичен.
2. Смэппить таблицы в node/edge структуру.
3. Запустить dual-read сравнение ответов и [SLA](../../../glossary.md#abbr-079).
4. Оставить [OLTP](../../../glossary.md#abbr-060) ядро в реляционной БД, граф использовать как специализированный слой.
...
- попытка делать [BI](../../../glossary.md#abbr-008) wide-scan в графовом движке.
