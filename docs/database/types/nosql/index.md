...
1. Какой подтип NoSQL оптимален под ваш доминирующий запрос?
2. Какие инварианты должны быть защищены в eventual-consistent контуре?
3. Как организован fallback при рассинхронизации реплик/индекса?
4. Есть ли план обратимой миграции?

## Чек-лист самопроверки

- выбран подтип NoSQL под конкретный access pattern;
- описаны правила целостности и компенсации;
- ключи распределения и индексы протестированы на нагрузке;
- определена стратегия миграции и rollback;
- выполнены требования безопасности и аудита.
