...
- [TLS](../../../glossary.md#abbr-088) между клиентом и кластером;
- role-based access c минимальными правами;
- шифрование at-rest;
- маскирование чувствительных полей ([PII](../../../glossary.md#abbr-063)/PCI) и аудит.
...
3. Настроить [CDC](../../../glossary.md#abbr-014)/dual-write и валидацию консистентности.
