...
1. Какие транзакции обязаны быть глобально консистентными?
2. Где допустим local read и bounded staleness?
3. Какой ключ распределения минимизирует hot partitions?
4. Как подтвержден failover в SLA-сценариях?

## Чек-лист самопроверки

- выбран тип NewSQL (distributed SQL / HTAP) под реальную нагрузку;
- документирован CAP/PACELC-компромисс;
- ключи и партиционирование протестированы на hot spots;
- есть автоматизированный failover и DR-тест;
- учтены затраты на межрегиональный трафик и хранение.
