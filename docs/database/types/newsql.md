# NewSQL базы данных
NewSQL сочетает [SQL](../../glossary.md#abbr-084)-модель и ACID-транзакции с горизонтальным масштабированием распределенных систем.
...
- управлять компромиссами [CAP](../../glossary.md#abbr-013)/[PACELC](../../glossary.md#abbr-061) и стоимостью межрегионального трафика.
...
| YugabyteDB | совместимость с PostgreSQL [API](../../glossary.md#abbr-005), распределенные транзакции | сложность эксплуатационного тюнинга | high-availability [OLTP](../../glossary.md#abbr-060), гибрид cloud/on-prem |
...
3. Закладывайте network RTT между регионами в [SLA](../../glossary.md#abbr-079) транзакций.
4. Тестируйте failover/switchover и split-brain сценарии.
5. Держите явный runbook rebalancing и capacity expansion.

## Типовые ошибки

- перенос monolith [SQL](../../glossary.md#abbr-084)-схемы без учета распределенности;
