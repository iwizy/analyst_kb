...
1. Какие инварианты данных нельзя нарушать даже при сбоях сети?
2. Какой read/write профиль ожидается на горизонте 12 месяцев?
3. Какие запросы должны укладываться в p95/p99 SLA?
4. Где нужна strong consistency, а где допустима eventual?
5. Какой DR-сценарий покрывает ваши RTO/RPO?

## Чек-лист самопроверки

- определены объем, рост и пиковая нагрузка;
- выбран тип БД и обоснован CAP/PACELC компромисс;
- описаны индексы и схема данных под ключевые запросы;
- есть план репликации, backup и failover;
- есть ссылки на стандарты, источники и runbook.
