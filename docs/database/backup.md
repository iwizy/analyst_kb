...
Backup — обязательная часть надежности данных. Ключевой показатель зрелости: не факт наличия бэкапа, а подтвержденная восстанавливаемость в заданный RTO/RPO.
...
1. Какой фактический, а не целевой RTO/RPO?
2. Где хранятся offsite копии и как контролируется доступ?
3. Как часто проводится полный restore drill?
4. Какой процент backup проверен на восстановление?

## Чек-лист самопроверки

- определены и согласованы RPO/RTO;
- настроен multi-tier backup (full/incremental/PITR);
- есть offsite и immutable политика;
- восстановление регулярно тестируется;
- runbook и роли актуальны.
