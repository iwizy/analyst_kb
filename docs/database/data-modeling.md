...
1. Какие доменные инварианты модель должна гарантировать?
2. Какие запросы являются критичными для SLA?
3. Где проходят границы bounded contexts?
4. Как будет выполняться эволюция схемы без downtime?

## Чек-лист самопроверки

- есть концептуальная, логическая и физическая модель;
- ключевые запросы и SLA отражены в проектировании;
- определены ключи, связи и ограничения целостности;
- есть миграционная стратегия и тесты данных;
- модель согласована с DDD границами контекстов.
