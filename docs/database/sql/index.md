...
Они определяют структуру базы данных. Примеры:
...
- Реляционные базы данных: данные организованы в виде таблиц (строки и столбцы).
- Ключи: первичные (PRIMARY KEY) и внешние ключи (FOREIGN KEY) обеспечивают целостность данных.
- Индексы: ускоряют выполнение запросов.
- Функции агрегирования: такие как COUNT, SUM, AVG, MAX, MIN.
