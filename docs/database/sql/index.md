...
- CI/CD для SQL-артефактов, процедур и UDF;
...
1. Сначала понять профиль запроса (OLTP vs OLAP).
...
1. Какие запросы в системе OLTP, а какие OLAP?
2. Что именно в плане выполнения создает основную задержку?
3. Какие индексы реально используются оптимизатором?
4. Какой уровень изоляции нужен бизнес-процессу?

## Чек-лист самопроверки

- ключевые запросы и SLA формализованы;
- планы выполнения изучены для top-N дорогих запросов;
- индексная стратегия документирована;
- стратегия работы с блокировками и deadlocks согласована;
- SQL-изменения встроены в CI/CD.
