...
- [CI/CD](../../glossary.md#abbr-017) для SQL-артефактов, процедур и [UDF](../../glossary.md#abbr-090);
...
## Транзакции и оптимизация: где смотреть подробно

- [Транзакции, блокировки и дедлоки](transactions-and-locking.md)
- [Планы выполнения и оптимизация SQL](explain-and-optimization.md)
