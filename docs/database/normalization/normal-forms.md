...
1. Какие аномалии были устранены после перехода на 3NF?
2. Есть ли реальные запросы, оправдывающие денормализацию?
3. Где в вашей модели детерминант не является ключом?
4. Как контролируется согласованность витрин с source таблицами?

## Чек-лист самопроверки

- выполнена декомпозиция минимум до 3NF где это уместно;
- BCNF проверена для критичных сущностей;
- денормализация вынесена в аналитический контур;
- materialized views имеют refresh и quality checks;
- документированы зависимости и trade-off.
