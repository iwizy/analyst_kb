...
- обратная денормализация в [OLAP](../../glossary.md#abbr-059) и контроль согласованности витрин.
...
- 4NF: устраняет мультизначные зависимости (редко для обычного [OLTP](../../glossary.md#abbr-060), но полезно в сложных доменах каталога).
- 5NF: устраняет join dependencies (высокая сложность, чаще академические/специализированные кейсы).

## [Денормализация](../../glossary.md#term-020) для OLAP
...
| Решение | Плюс | Минус |
| --- | --- | --- |
| [Нормализация](../../glossary.md#term-048) | лучше целостность, меньше дублирование | больше join |
...
2. Для [BI](../../glossary.md#abbr-008) используйте денормализацию в отдельном аналитическом слое.
