# [Нормализация](../../glossary.md#term-048) и денормализация

Нормализация снижает избыточность и аномалии данных в [OLTP](../../glossary.md#abbr-060), денормализация ускоряет чтение и аналитику в [OLAP](../../glossary.md#abbr-059)/read-heavy сценариях.
...
| Критерий | Нормализация | [Денормализация](../../glossary.md#term-020) |
| --- | --- | --- |
...
| [BI](../../glossary.md#abbr-008)/аналитика, стабильные чтения | денормализованная витрина / star schema |
...
3. Для витрин вводите [SLA](../../glossary.md#abbr-079) свежести и quality checks.
