...
1. Какие сценарии требуют strong consistency и почему?
2. Какой уровень изоляции нужен для критичных транзакций?
3. Как система ведет себя при network partition?
4. Как разрешаются конфликты между регионами?

## Чек-лист самопроверки

- consistency-требования зафиксированы по сценариям;
- выбран и обоснован replication strategy;
- протестированы lost update/double spend кейсы;
- реализованы idempotency и компенсационные механизмы;
- есть runbook действий при partition и lag.
