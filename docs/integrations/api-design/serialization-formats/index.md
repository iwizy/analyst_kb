...
1. Что важнее для конкретного канала: читаемость или размер/скорость?
2. Как обеспечивается эволюция схем без остановки клиентов?
3. Где хранится schema registry и кто его owner?
4. Как вы проверяете совместимость схем в CI?

## Чек-лист самопроверки

- выбран формат по SLA и типу потребителей;
- есть правила schema evolution и versioning;
- включены автоматические проверки схем;
- документированы примеры сериализации/десериализации;
- измерены latency и payload size на тестовых данных.
