...
- использовать mesh для [mTLS](../../glossary.md#abbr-052), retries, telemetry.
...
- оптимизировать [TCO](../../glossary.md#abbr-087) self-hosted vs managed.
...
## Сравнение инструментов [API](../../glossary.md#abbr-005) Gateway

| Инструмент | Сильные стороны | Ограничения |
| --- | --- | --- |
| Kong | богатый open-source ecosystem, плагины | enterprise-фичи платные |
| Apigee | зрелое API management и аналитика | высокий [TCO](../../glossary.md#abbr-087) |
...
- отсутствие owner на [API](../../glossary.md#abbr-005) onboarding и lifecycle;
