# [Версионирование](../../glossary.md#term-015) [API](../../glossary.md#abbr-005)

Версионирование нужно для безопасной эволюции API без срыва [SLA](../../glossary.md#abbr-079) и внезапных поломок клиентов.
...
- автоматизировать compatibility checks в [CI](../../glossary.md#abbr-016);
...
| SemVer контракта | `2.3.1` | понятно в [CI/CD](../../glossary.md#abbr-017) и каталогах | нужно дисциплинированное управление |
...
## [Интеграция](../../glossary.md#term-033) с Gateway и Mesh
