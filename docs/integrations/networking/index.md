...
1. Какие сетевые факторы сильнее всего влияют на ваши API?
2. Где нужен TCP, а где оправдан UDP/QUIC?
3. Какие сетевые метрики алертятся в production?
4. Как диагностируется деградация между сервисами?

## Чек-лист самопроверки

- зафиксированы сетевые требования и SLO;
- известны критичные узкие места сети;
- применяются корректные timeout/retry настройки;
- есть стандарт диагностики инцидентов;
- метрики и трассировка сетевого слоя подключены.
