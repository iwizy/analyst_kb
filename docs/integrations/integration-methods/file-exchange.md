...
- внедрять шифрование и подпись (PGP, [TLS](../../glossary.md#abbr-088), SSH);
- проектировать retry, архивирование, дедупликацию;
- контролировать [SLA](../../glossary.md#abbr-079) на доставку и обработку.

### Продвинутый уровень

- автоматизировать pipeline передачи через [ETL](../../glossary.md#abbr-033)/orchestration;
...
| --- | --- | --- |
| [CSV](../../glossary.md#abbr-022) | простые табличные выгрузки | типизация и экранирование |
...
- расписание отправки и [SLA](../../glossary.md#abbr-079) окна;
...
- [RFC](../../glossary.md#abbr-072) 959 FTP: <https://www.rfc-editor.org/rfc/rfc959>
