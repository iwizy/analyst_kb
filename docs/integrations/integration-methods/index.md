...
1. Какие операции должны быть синхронными, а какие лучше делать асинхронно?
2. Что важнее в вашем кейсе: latency или надежная доставка?
3. Где в архитектуре возможна сильная связность и как ее ограничить?
4. Какие механизмы компенсации предусмотрены при частичных сбоях?

## Чек-лист самопроверки

- выбран интеграционный канал под SLA и риск;
- контракт и error model формализованы;
- внедрены паттерны надежности;
- есть стратегия observability и rollback;
- ответственность команд и ownership каналов определены.
