...
- применять Saga, [CQRS](../../glossary.md#abbr-020) и Event-Driven Architecture;
...
### [Оркестрация](../../glossary.md#term-051)
...
| [Паттерн](../../glossary.md#term-052) | Суть | Пример |
| --- | --- | --- |
...
| Command pattern | явные команды вместо вызовов [CRUD](../../glossary.md#abbr-021) | `ApproveLoan`, `ShipOrder` |
