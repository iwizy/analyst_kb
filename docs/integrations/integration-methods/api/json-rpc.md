...
1. Есть ли единая taxonomy методов и error codes?
2. Как ограничены batch-запросы по размеру?
3. Какие команды требуют идемпотентности?
4. Как обеспечивается совместимость методов при эволюции?

## Чек-лист самопроверки

- спецификация JSON-RPC формализована;
- определены ошибки и правила retry;
- есть лимиты на batch и payload size;
- versioning методов документирован;
- наблюдаемость покрывает все RPC-вызовы.
